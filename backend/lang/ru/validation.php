...
return [
    ...
    'lte' => [
        'array' => 'Количество элементов в :attribute не должно превышать :value.',
        'file' => 'Размер :attribute не должен превышать :value Кб.',
        'numeric' => 'Значение :attribute не должно превышать :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанный :attribute обнаружен в утечке данных.',
    ],
